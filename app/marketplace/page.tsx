  ...
  return (
    <AuthProvider>
      <div className="min-h-screen bg-soft-cream">
        ...
        {/* Hero Section */}
        <section className="bg-deep-teal py-12 px-4 sm:px-6 lg:px-8 shadow-md">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className="text-3xl md:text-4xl font-serif font-bold text-soft-cream mb-4 animate-fadeIn">
              Discover Authentic Indian Crafts
            </h1>
            <p className="text-xl text-soft-cream/90 mb-8 max-w-2xl mx-auto">
            ...
            <div className="max-w-2xl mx-auto relative">
              ...
              <Input
                ...
                className="pl-12 pr-4 py-3 text-lg border-0 bg-white/95 focus:bg-white rounded-lg shadow-sm"
              />
            </div>
          </div>
        </section>
