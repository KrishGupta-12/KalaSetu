      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-warm-brown/20 shadow-lg">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl font-serif text-deep-teal">Join Kala Setu</CardTitle>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-3">
                <Label className="text-deep-teal font-medium">I want to join as:</Label>
                <RadioGroup
                  value={formData.role}
                  onValueChange={(value) => setFormData({ ...formData, role: value as "artisan" | "buyer" })}
                  className="grid grid-cols-1 gap-3"
                >
                  <div className="flex items-center space-x-4 border border-warm-brown/30 rounded-lg p-4 hover:bg-heritage-gold/5 hover:border-heritage-gold/40 transition-all duration-200 cursor-pointer">
                    <RadioGroupItem value="artisan" id="artisan" />
                    <Label htmlFor="artisan" className="flex items-center cursor-pointer flex-1">
                      <Palette className="w-5 h-5 mr-3 text-sunset-orange" />
                      <div>
                        <span className="font-medium text-deep-teal">Artisan</span>
                        <p className="text-sm text-warm-brown">Share your traditional crafts with the world</p>
                      </div>
                    </Label>
                  </div>
                  <div className="flex items-center space-x-4 border border-warm-brown/30 rounded-lg p-4 hover:bg-heritage-gold/5 hover:border-heritage-gold/40 transition-all duration-200 cursor-pointer">
                    ...
                    <Label htmlFor="buyer" className="flex items-center cursor-pointer flex-1">
                      <ShoppingBag className="w-5 h-5 mr-3 text-soft-blue" />
                      <div>
                        <span className="font-medium text-deep-teal">Buyer</span>
                        <p className="text-sm text-warm-brown">Discover authentic handcrafted treasures</p>
                      </div>
                    </Label>
                  </div>
                </RadioGroup>
